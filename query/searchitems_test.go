...
func TestResourcesInSearchItems(t *testing.T) {
	testCases := []struct {
		...
		{q: NewSearchItems("", "", "").EnableOffersV2(), str: `{"Operation":"SearchItems","Resources":["OffersV2.Listings.Availability","OffersV2.Listings.Condition","OffersV2.Listings.DealDetails","OffersV2.Listings.IsBuyBoxWinner","OffersV2.Listings.LoyaltyPoints","OffersV2.Listings.MerchantInfo","OffersV2.Listings.Price","OffersV2.Listings.Type"]}`},
